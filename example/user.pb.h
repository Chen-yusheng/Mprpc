...
template<> ::mprpc::RegisterRequest* Arena::CreateMaybeMessage<::mprpc::RegisterRequest>(Arena*);
...
class RegisterRequest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mprpc.RegisterRequest) */ {
 public:
  RegisterRequest();
  ...
  // @@protoc_insertion_point(class_scope:mprpc.RegisterRequest)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegisterRequest::id() const {
  // @@protoc_insertion_point(field_get:mprpc.RegisterRequest.id)
  return _internal_id();
}
...
inline void RegisterRequest::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:mprpc.RegisterRequest.id)
}
...
inline const std::string& RegisterRequest::name() const {
  // @@protoc_insertion_point(field_get:mprpc.RegisterRequest.name)
  return _internal_name();
}
inline void RegisterRequest::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:mprpc.RegisterRequest.name)
}
inline std::string* RegisterRequest::mutable_name() {
  // @@protoc_insertion_point(field_mutable:mprpc.RegisterRequest.name)
  return _internal_mutable_name();
}
...
inline void RegisterRequest::set_name(std::string&& value) {
  ...
  name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:mprpc.RegisterRequest.name)
}
inline void RegisterRequest::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mprpc.RegisterRequest.name)
}
inline void RegisterRequest::set_name(const void* value, size_t size) {
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mprpc.RegisterRequest.name)
}
...
inline std::string* RegisterRequest::release_name() {
  // @@protoc_insertion_point(field_release:mprpc.RegisterRequest.name)
...
inline void RegisterRequest::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name);
  // @@protoc_insertion_point(field_set_allocated:mprpc.RegisterRequest.name)
}
...
inline const std::string& RegisterRequest::pwd() const {
  // @@protoc_insertion_point(field_get:mprpc.RegisterRequest.pwd)
  return _internal_pwd();
}
inline void RegisterRequest::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:mprpc.RegisterRequest.pwd)
}
inline std::string* RegisterRequest::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:mprpc.RegisterRequest.pwd)
  return _internal_mutable_pwd();
}
...
inline void RegisterRequest::set_pwd(std::string&& value) {
  ...
  pwd_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:mprpc.RegisterRequest.pwd)
}
inline void RegisterRequest::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:mprpc.RegisterRequest.pwd)
}
inline void RegisterRequest::set_pwd(const void* value, size_t size) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:mprpc.RegisterRequest.pwd)
}
...
inline std::string* RegisterRequest::release_pwd() {
  // @@protoc_insertion_point(field_release:mprpc.RegisterRequest.pwd)
...
inline void RegisterRequest::set_allocated_pwd(std::string* pwd) {
  ...
  pwd_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pwd);
  // @@protoc_insertion_point(field_set_allocated:mprpc.RegisterRequest.pwd)
}
...
inline const ::mprpc::ResultCode& RegisterResponse::_internal_result() const {
  const ::mprpc::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::mprpc::ResultCode*>(
      &::mprpc::_ResultCode_default_instance_);
}
inline const ::mprpc::ResultCode& RegisterResponse::result() const {
  // @@protoc_insertion_point(field_get:mprpc.RegisterResponse.result)
  return _internal_result();
}
inline ::mprpc::ResultCode* RegisterResponse::release_result() {
...
inline ::mprpc::ResultCode* RegisterResponse::_internal_mutable_result() {
...
inline ::mprpc::ResultCode* RegisterResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:mprpc.RegisterResponse.result)
  return _internal_mutable_result();
}
inline void RegisterResponse::set_allocated_result(::mprpc::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
